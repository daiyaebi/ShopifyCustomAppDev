...
exports.CarrierServices = void 0;
const infrastructure_1 = require("../infrastructure");
/**
 * A service for manipulating Shopify's CarrierService API.
 */
class CarrierServices extends infrastructure_1.BaseService {
    ...
    create(carrierService) {
        return this.createRequest("POST", ".json", "carrier_service", { carrier_service: carrierService });
    }
    /**
     * Updates a new Carrier Service.
     */
    update(id, carrierService) {
        return this.createRequest("PUT", `${id}.json`, "carrier_service", { carrier_service: carrierService });
    }
    /**
     ...
     */
    get(id) {
        return this.createRequest("GET", `${id}.json`, "carrier_service");
    }
    /**
     ...
     */
    list() {
        return this.createRequest("GET", `.json`, "carrier_service");
    }
}
exports.CarrierServices = CarrierServices;
exports.default = CarrierServices;
